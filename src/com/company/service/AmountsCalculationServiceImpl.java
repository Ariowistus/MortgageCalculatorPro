...
public class AmountsCalculationServiceImpl implements AmountsCalculationService {
    ...
    public RateAmounts calculate(InputData inputData) {
        switch (inputData.getRateType()){
            ...
            default:
                throw new RuntimeException("Case not hundled");
    ...
    private RateAmounts calculateConstantRate(InputData inputData) {
        BigDecimal interestPercent = inputData.getIterestPercent();
    ...
    private BigDecimal calculateQ(BigDecimal iterestPercent) {
        return iterestPercent.divide(YEAR, 10, RoundingMode.HALF_UP).add(BigDecimal.ONE);
    }
